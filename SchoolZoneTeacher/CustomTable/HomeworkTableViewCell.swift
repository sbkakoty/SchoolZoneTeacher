...
class HomeworkTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var buttonEditHomework: UIButton!
    @IBOutlet weak var buttonHomeworkAttachment: UIButton!
    @IBOutlet weak var textDate: UILabel!
    @IBOutlet weak var labelSubject: UILabel!
    @IBOutlet weak var textSubject: UILabel!
    @IBOutlet weak var textRemarks: UILabel!
    @IBOutlet weak var labelCompletionDate: UILabel!
    @IBOutlet weak var textCompletionDate: UILabel!
